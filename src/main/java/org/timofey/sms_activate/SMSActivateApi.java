...
import org.timofey.sms_activate.client_enums.SMSActivateClientRentStatus;
import org.timofey.sms_activate.client_enums.SMSActivateClientStatus;
import org.timofey.sms_activate.error.SMSActivateBannedException;
import org.timofey.sms_activate.error.SMSActivateUnknownException;
import org.timofey.sms_activate.error.base.SMSActivateBaseException;
import org.timofey.sms_activate.error.base.SMSActivateBaseTypeError;
import org.timofey.sms_activate.error.wrong_parameter.SMSActivateWrongParameter;
import org.timofey.sms_activate.error.wrong_parameter.SMSActivateWrongParameterException;
import org.timofey.sms_activate.listener.SMSActivateExceptionListener;
import org.timofey.sms_activate.listener.SMSActivateWebClientListener;
import org.timofey.sms_activate.response.api_activation.*;
import org.timofey.sms_activate.response.api_activation.enums.SMSActivateGetStatusActivation;
import org.timofey.sms_activate.response.api_activation.enums.SMSActivateServerStatus;
import org.timofey.sms_activate.response.api_activation.enums.SMSActivateStatusNumber;
import org.timofey.sms_activate.response.api_activation.extra.SMSActivateCountryInfo;
import org.timofey.sms_activate.response.api_activation.extra.SMSActivateGetPriceInfo;
import org.timofey.sms_activate.response.api_activation.extra.SMSActivateServiceInfo;
import org.timofey.sms_activate.response.api_rent.SMSActivateGetRentListResponse;
import org.timofey.sms_activate.response.api_rent.SMSActivateGetRentServicesAndCountriesResponse;
import org.timofey.sms_activate.response.api_rent.SMSActivateGetRentStatusResponse;
import org.timofey.sms_activate.response.api_rent.enums.SMSActivateRentStatus;
...
import org.timofey.sms_activate.response.qiwi.SMSActivateGetQiwiRequisitesResponse;
...
public class SMSActivateApi {
   ...
   */
  public SMSActivateApi(@NotNull ActivationService service, @NotNull String apiKey)
  ...
  public SMSActivateGetNumbersStatusResponse getNumbersStatus(@Nullable Integer countryId, @Nullable Set<String> operatorSet)
    ...
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_NUMBERS_STATUS);
  ...
  private SMSActivateGetMultiServiceNumberResponse getMultiServiceNumber(
    ...
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_MULTI_SERVICE_NUMBER);
  ...
  public SMSActivateGetFullSmsResponse getFullSms(long activationId) throws SMSActivateBaseException {
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_FULL_SMS);
    smsActivateURLBuilder.append(SMSActivateURLKey.ID, String.valueOf(activationId));
  ...
  public SMSActivateGetCountriesResponse getCountries() throws SMSActivateBaseException {
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_COUNTRIES);
    String jsonFromServer = new SMSActivateWebClient(smsActivateWebClientListener).getOrThrowCommonException(smsActivateURLBuilder, validator);
    SMSActivateJsonParser jsonParser = new SMSActivateJsonParser();
  ...
  public SMSActivateGetQiwiRequisitesResponse getQiwiRequisites() throws SMSActivateBaseException {
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_QIWI_REQUISITES);
    String jsonFromServer = new SMSActivateWebClient(smsActivateWebClientListener).getOrThrowCommonException(smsActivateURLBuilder, validator);
    SMSActivateJsonParser jsonParser = new SMSActivateJsonParser();
  ...
  public SMSActivateActivation getAdditionalService(long parentActivationId, @NotNull String service) throws SMSActivateBaseException {
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_ADDITIONAL_SERVICE);
  ...
  public SMSActivateGetRentServicesAndCountriesResponse getRentServicesAndCountries(int countryId, @Nullable Set<String> operatorSet, int hours)
    ...
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_RENT_SERVICES_AND_COUNTRIES);
    smsActivateURLBuilder.append(SMSActivateURLKey.COUNTRY, String.valueOf(countryId))
      .append(SMSActivateURLKey.OPERATOR, operator)
  ...
  public SMSActivateRentActivation getRentNumber(
    ...
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_RENT_NUMBER);
  ...
  public SMSActivateGetRentStatusResponse getRentStatus(int rentId) throws SMSActivateBaseException {
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_RENT_STATUS);
  ...
  public SMSActivateRentStatus setRentStatus(int rentId, @NotNull SMSActivateClientRentStatus status)
    throws SMSActivateBaseException {
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.SET_RENT_STATUS);
    smsActivateURLBuilder.append(SMSActivateURLKey.ID, String.valueOf(rentId))
  ...
  public SMSActivateGetRentListResponse getRentList() throws SMSActivateBaseException {
    SMSActivateURLBuilder smsActivateURLBuilder = new SMSActivateURLBuilder(activationService, apiKey,
            SMSActivateAction.GET_RENT_LIST);
